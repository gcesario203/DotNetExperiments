...
namespace Catalog.API.Controllers
{
    ...
    public class CatalogController : ControllerBase
    {
        ...
        public CatalogController(IProductRepository<Product> repository, ILogger<CatalogController> logger)
        {
        ...
        {
            var products = await _repository.GetItemByCategory(category);
            return Ok(products);
        }
        ...
        {
            var products = await _repository.GetItemByName(name);
            return Ok(products);
        }
        ...
        {
            return Ok(await _repository.UpdateItem(product));
        }
